...
namespace KGUI
{
	...
	public static class ToolSet
	{
	    ...
	    public static bool IsEmptyRect(ref Rect rect)
	    {
            return Mathf.Approximately(rect.x, 0) && Mathf.Approximately(rect.y, 0) && Mathf.Approximately(rect.width, 0) || Mathf.Approximately(rect.height, 0);
	    }
